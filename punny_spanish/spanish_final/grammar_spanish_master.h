...
Verb 'atacar' 'ataco' 'atacas' 'ataca' 'atacamos' 'atacáis' 'atacan'
    ...
    'ataca' 'ataque' 'atacad' 'ataquen' 'atacando' 'atacado'
...
! Puntuación
Verb 'puntuación' 'puntos' 'score' 'marcador' 'tanteo' 'puntaje'
    *                                           -> Score;
...
Verb 'oler' 'huelo' 'hueles' 'huele' 'olemos' 'oléis' 'huelen'
    ...
    'huele' 'huela' 'oled' 'huelan' 'oliendo' 'olido'
    ...
    'olfatea' 'olfatee' 'olfatead' 'olfateen' 'olfateando' 'olfateado'
