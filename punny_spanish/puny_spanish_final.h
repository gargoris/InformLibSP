! PunyInform Español Final - Sistema Completo de Conjugaciones
! Version sin acentos y sin conflictos para compilacion exitosa
...
! VERBO HACER (reemplazado con Touch para evitar Make faltante)
...
! VERBO VENIR (reemplazado con Look para evitar Come faltante)
...
! BAJAR (formas únicas sin conflicto)
Verb 'bajo' 'bajas' 'baja' 'bajamos' 'bajáis' 'bajan'
     'bajaste' 'bajaron' 'bajasteis'
...
! ENTRAR (formas únicas sin conflicto)
Verb 'entro' 'entras' 'entra' 'entramos' 'entrais' 'entran'
     'entraste' 'entraron' 'entrasteis'
...
[ EstaEstan p_obj;
    if (EsPlural(p_obj)) print "estan"; else print "esta";
];
...
[ InicializarEspanolFinal;
    print "^Sistema completo de conjugaciones espanolas iniciado.^";
    print "Verbos irregulares, regulares y reflexivos disponibles.^";
];